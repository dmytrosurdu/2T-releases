...
renormalized Peierls package (UOM-P1--P5) from the SK/HJ structure.
...
The UOM-P1--P5 package holds, providing a gauge-independent, renormalized Peierls bracket on
...
and it is supplied in UOM by the renormalized causal/Peierls package (UOM-P1--P5) below.
\end{remark}
...
\subsection{Renormalized causal structure and Peierls bracket on the receiver head (UOM-P1--P5)}
...
The following theorem summarizes what is proved in the five subsubsections below and is the only object imported
by the two--time program.

\begin{theorem}[UOM Peierls package at finite cutoff (UOM-P1--P5)]
...
\paragraph{Roadmap.}
Theorem~\ref{thm:uom-peierls-package} is proved by the five subsubsections below, in order:
...
$\mathcal F_{\rm s.loc}^\Lambda$ and closure under the bracket.
...
% Place this subsection after the UOM-P1--P5 package subsection
% (e.g. after \subsubsection{UOM-P5: ...}) inside the promoted section
% \section{Two--times semiclassical characterization: acceptance, diagonalization, and flatness}
% ======================================================================
...
\paragraph{Relationship to UOM-P1--P5.}
...
and the sufficiently local class $\mathcal F_{\rm s.loc}^\Lambda$ closed under Peierls (UOM-P5).
...
Assume the UOM Peierls package (UOM-P1--P5) at finite cutoff, the uniformity inputs
